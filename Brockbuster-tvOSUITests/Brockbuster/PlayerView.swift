...
struct PlayerView: View {
    ...
    var body: some View {
        ...
        .onDisappear {
            ...
            // IMPORTANT:
            // When the app moves to the background, SwiftUI can transiently
            // trigger lifecycle callbacks. We must NOT treat backgrounding as
            // a user-initiated stop, otherwise Jellyfin will end the session
            // and playback may be interrupted.
...
#if os(iOS)
        // Ensure the session can continue when the app backgrounds and enable
        // full video playback features on iPhone/iPad (PiP + Now Playing).
        do {
